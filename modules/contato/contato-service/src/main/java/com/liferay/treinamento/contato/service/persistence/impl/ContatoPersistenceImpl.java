...
import com.liferay.treinamento.contato.service.persistence.ContatoUtil;
import com.liferay.treinamento.contato.service.persistence.impl.constants.ContatoPersistenceConstants;
 ...
 * @generated
 */
@Component(service = {ContatoPersistence.class, BasePersistence.class})
public class ContatoPersistenceImpl
	...
	public List<Contato> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Contato>)finderCache.getResult(finderPath, finderArgs);
	...
	public ContatoPersistenceImpl() {
		...
		setTable(ContatoTable.INSTANCE);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(ContatoImpl.class);
	}
	...
	public void clearCache(Contato contato) {
		entityCache.removeResult(ContatoImpl.class, contato);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ContatoImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(ContatoModelImpl contatoModelImpl) {
		...
		finderCache.putResult(_finderPathFetchByUUID_G, args, contatoModelImpl);
	}
	...
	public Contato updateImpl(Contato contato) {
		...
		entityCache.putResult(ContatoImpl.class, contatoModelImpl, false, true);
	...
	@Reference
	private ContatoModelArgumentsResolver _contatoModelArgumentsResolver;
